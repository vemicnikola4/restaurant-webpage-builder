        ...
        <div className="flex w-full justify-start gap-2">
            ...
            <div className="h-full flex gap-2 basis-1/3 items-center">
                ...
                <div className="flex w-full justify-end">
                    <input type="checkbox" name={modal.day} id="" onClick={e => setOpen(ind)} checked={item.open} />
                </div>
            ...
            <div className={"basis-1/3 " + (!item.open ? 'opacity-20' : '')}>
                <div>
                    ...
                    <select name="" value={item.openHours} id="" className={"p-2 rounded-md w-full " + themeInUse.input} onChange={e => setOpenHours(e.target.value, ind)} disabled={!item.open}>
                    ...
                    <select name="" id="" value={item.openMinutes} className={"p-2 rounded-md w-full " + themeInUse.input} onChange={e => setOpenMinutes(e.target.value, ind)} disabled={!item.open}>
            ...
            <div className={"basis-1/3 " + (!item.open ? 'opacity-20' : '')}>
                <div>
                    ...
                    <select name="" value={item.closingHours} id="" className={"p-2 rounded-md w-full " + themeInUse.input} onChange={e => setClosingHours(e.target.value, ind)} disabled={!item.open}>
                        <option value="">h</option>
                        <option value="1">00</option>
                        <option value="2">01</option>
                        <option value="3">02</option>
                    ...
                    <select name="" id="" value={item.closingMinutes} className={"p-2 rounded-md w-full " + themeInUse.input} onChange={e => setClosingMinutes(e.target.value, ind)} disabled={!item.open}>
                        <option value="">min</option>
                        <option value="0">00</option>
                        <option value="15">15</option>
                        <option value="30">30</option>
