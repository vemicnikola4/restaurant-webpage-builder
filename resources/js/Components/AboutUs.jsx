                ...
                <div className="relative w-5/6 py-3 mb-3">
                    {
                        page.aboutUs ?
                            <div className=" text-center mt-2 w-full flex justify-center md:justify-end md:absolute bottom-1 ">
                                <div className="w-32 py-3 p-6 rounded-sm bg-green-500 bg-opacity-80 hover:bg-opacity-90 hover:cursor-pointer" onClick={e => handleAboutUsSubmit()}>
                                    {
                            ...
                            :
                            <div className=" text-center mt-2 w-full flex justify-center md:justify-end md:absolute bottom-1 ">
                                <div className="w-32 py-3 p-6 rounded-sm bg-blue-500 bg-opacity-80 hover:bg-opacity-90 hover:cursor-pointer" onClick={e => handleAboutUsSubmit()}>
                                {
