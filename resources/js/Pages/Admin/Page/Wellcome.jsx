...
"Šid", "Štimlje", "Štrpce"
    ...
    const handleSubmit = (e)=>{
        e.preventDefault();
        router.post(route('admin.page.store', values));
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        ...
                        <h1>{locale == 'en' ? 'Wellcome admin' : translate['Wellcome admin']}</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex text-gray-700 justify-center items-center h-fit px-6">
                <div className=" py-8 w-full md:w-2/3 shadow-lg bg-white rounded-md w-2/4  flex flex-col justify-center items-center  px-2 md:px-4">
                    <div className="py-4">
                        ...
                        {locale == 'en' ? 'Create New Page' : translate['Create New Page']}
